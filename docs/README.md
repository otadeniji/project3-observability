...
# Initialize database (creates observability.db)
python3 src/models.py --init-db
...
python3 tests/test_alerting.py
```
...
This project was built using **Vibe Coding** methodology - directing AI agents to build the system while maintaining architectural oversight. All prompts and iterations are logged in `prompts.md`.
...
This is a demonstration project showcasing AI-powered development workflows. Feel free to fork and extend with:
